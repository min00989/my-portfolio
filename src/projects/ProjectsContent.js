...
import pawfit from "./images/pawfit.png";
            ...
            <div className="ProjectContent_container">
                ...
                <div className="ProjectContent_content">
                    <div className="ProjectContent_content-name">
                        <div className="ProjectContent_content-name1">PAWFIT</div>
                        <div className="ProjectContent_content-date">2024</div>
                    </div>
                    <div className="ProjectContent-tag">
                        <div className="ProjectContent_content-tag">Development Project</div>
                    </div>
                </div>
                ...
                <div className="ProjectContent-wrapper">
                    ...
                    <div className="ProjectContent_content">
                        ...
                        <div className="ProjectContent_content-name">
                            ...
                            <div className="ProjectContent-tag3" >
                                <div className="ProjectContent_content-tag2">KOREA CONSUMER AGENCY</div>
                            </div>
                        </div>
                    </div>
                </div>
